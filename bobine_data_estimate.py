...
def add_all_bobines(bobine_store: BobineStore) -> None:
    ...
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="blanc", laize=140, longueur=700, poses=[1, 1, 1]))
    i += 1
    ...
    bobine_store.add_bobine(Bobine(code=i, color="blanc", laize=140, longueur=700, poses=[3]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="blanc", laize=140, longueur=700, poses=[1, 1]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="blanc", laize=140, longueur=700, poses=[4]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="blanc", laize=140, longueur=700, poses=[3]))
    ...
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="blanc", laize=150, longueur=700, poses=[1, 1]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="blanc", laize=150, longueur=700, poses=[2]))
    i += 1
    ...
    bobine_store.add_bobine(Bobine(code=i, color="orange", laize=180, longueur=700, poses=[4]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="cx", laize=190, longueur=700, poses=[0]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="prune", laize=190, longueur=500, poses=[0]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="cx", laize=190, longueur=500, poses=[1]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="blanc", laize=190, longueur=700, poses=[0]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="blanc", laize=190, longueur=700, poses=[1, 1, 1, 1]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="ecru", laize=190, longueur=700, poses=[0]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="ecru", laize=190, longueur=700, poses=[1, 1, 1, 1]))
    i += 1
    ...
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="orange", laize=320, longueur=500, poses=[1, 1]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="rouge", laize=320, longueur=500, poses=[0]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="rouge", laize=320, longueur=500, poses=[1, 1]))
    i += 1
