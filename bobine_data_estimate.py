from bobine_store import Bobine, BobineStore


def add_all_bobines(bobine_store: BobineStore) -> None:
    i = 0
    ...
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="blanc", laize=130, longueur=700, poses=[1, 2]))
    i += 1
    ...
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="ecru", laize=130, longueur=700, poses=[1, 2]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="ecru", laize=130, longueur=700, poses=[1, 2]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="ecru", laize=130, longueur=700, poses=[1, 2]))
    ...
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="ecru", laize=130, longueur=1400, poses=[7]))
    i += 1
    ...
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="blanc", laize=140, longueur=700, poses=[1, 2]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="blanc", laize=140, longueur=700, poses=[1, 2]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="blanc", laize=140, longueur=700, poses=[1, 2]))
    ...
    bobine_store.add_bobine(Bobine(code=i, color="ecru", laize=140, longueur=700, poses=[4]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="ecru", laize=140, longueur=700, poses=[1, 2]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="ecru", laize=140, longueur=700, poses=[4]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="ecru", laize=140, longueur=700, poses=[4]))
    ...
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="jaune", laize=140, longueur=700, poses=[1, 2]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="jaune", laize=140, longueur=700, poses=[1, 2]))
    i += 1
    ...
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="orange", laize=140, longueur=700, poses=[1, 2]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="orange", laize=140, longueur=700, poses=[1, 2]))
    i += 1
    ...
    bobine_store.add_bobine(Bobine(code=i, color="noir", laize=140, longueur=500, poses=[4]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="noir", laize=140, longueur=500, poses=[1, 2]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="noir", laize=140, longueur=500, poses=[4]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="orange", laize=140, longueur=500, poses=[4]))
    ...
    bobine_store.add_bobine(Bobine(code=i, color="prune", laize=140, longueur=500, poses=[0]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="prune", laize=140, longueur=500, poses=[1, 2]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="prune", laize=140, longueur=500, poses=[4]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="prune", laize=140, longueur=500, poses=[4]))
    ...
    bobine_store.add_bobine(Bobine(code=i, color="rouge", laize=140, longueur=500, poses=[4]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="vert", laize=140, longueur=700, poses=[1, 2]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="blanc", laize=140, longueur=700, poses=[1, 2]))
    i += 1
    ...
    bobine_store.add_bobine(Bobine(code=i, color="ivoire", laize=150, longueur=500, poses=[4]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="ivoire", laize=150, longueur=500, poses=[1, 2]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="ivoire", laize=150, longueur=500, poses=[4]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="ivoire", laize=150, longueur=500, poses=[4]))
    ...
    bobine_store.add_bobine(Bobine(code=i, color="jaune", laize=150, longueur=500, poses=[4]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="jaune", laize=150, longueur=500, poses=[1, 2]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="jaune", laize=150, longueur=500, poses=[4]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="jaune", laize=150, longueur=500, poses=[1, 2]))
    ...
    bobine_store.add_bobine(Bobine(code=i, color="marron", laize=150, longueur=500, poses=[4]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="marron", laize=150, longueur=500, poses=[1, 2]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="marron", laize=150, longueur=500, poses=[4]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="marron", laize=150, longueur=500, poses=[1, 2]))
    ...
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="noir", laize=150, longueur=500, poses=[1, 2]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="noir", laize=150, longueur=500, poses=[1, 2]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="noir", laize=150, longueur=500, poses=[4]))
    ...
    bobine_store.add_bobine(Bobine(code=i, color="orange", laize=150, longueur=500, poses=[4]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="orange", laize=150, longueur=500, poses=[1, 2]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="orange", laize=150, longueur=500, poses=[1, 2]))
    i += 1
    ...
    bobine_store.add_bobine(Bobine(code=i, color="rouge", laize=150, longueur=500, poses=[4]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="rouge", laize=150, longueur=500, poses=[1, 2]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="rouge", laize=150, longueur=500, poses=[4]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="rouge", laize=150, longueur=500, poses=[4]))
    ...
    bobine_store.add_bobine(Bobine(code=i, color="ecru", laize=150, longueur=700, poses=[4]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="ecru", laize=150, longueur=700, poses=[1, 2]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="ecru", laize=150, longueur=700, poses=[1, 2]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="ecru", laize=150, longueur=700, poses=[1, 2]))
    ...
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="jaune", laize=150, longueur=700, poses=[1, 2]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="orange", laize=150, longueur=700, poses=[0]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="orange", laize=150, longueur=700, poses=[1, 2]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="orange", laize=150, longueur=700, poses=[1, 2]))
    i += 1
    ...
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="jaune", laize=173, longueur=700, poses=[0]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="blanc", laize=173, longueur=700, poses=[0]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="blanc", laize=173, longueur=700, poses=[1, 2]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="ecru", laize=173, longueur=700, poses=[0]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="ecru", laize=173, longueur=700, poses=[1, 2]))
    i += 1
    ...
    bobine_store.add_bobine(Bobine(code=i, color="ecru", laize=173, longueur=700, poses=[2]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="jaune", laize=173, longueur=700, poses=[1, 2]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="ivoire", laize=180, longueur=500, poses=[1, 2]))
    i += 1
    ...
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="jaune", laize=180, longueur=500, poses=[1, 2]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="jaune", laize=180, longueur=500, poses=[4]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="marron", laize=180, longueur=500, poses=[0]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="marron", laize=180, longueur=500, poses=[1, 2]))
    i += 1
    ...
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="noir", laize=180, longueur=500, poses=[1, 2]))
    i += 1
    ...
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="rouge", laize=180, longueur=500, poses=[1, 2]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="rouge", laize=180, longueur=500, poses=[2]))
    i += 1
    ...
    bobine_store.add_bobine(Bobine(code=i, color="blanc", laize=180, longueur=700, poses=[2]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="blanc", laize=180, longueur=700, poses=[1, 2]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="blanc", laize=180, longueur=700, poses=[1, 2]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="blanc", laize=180, longueur=700, poses=[2]))
    ...
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="ecru", laize=180, longueur=700, poses=[1, 2]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="ecru", laize=180, longueur=700, poses=[3]))
    i += 1
    ...
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="jaune", laize=180, longueur=700, poses=[1, 2]))
    i += 1
    ...
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="orange", laize=180, longueur=700, poses=[1, 2]))
    i += 1
    ...
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="ecru", laize=190, longueur=700, poses=[1, 2]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="ecru", laize=190, longueur=700, poses=[2]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="ecru", laize=190, longueur=700, poses=[1, 2]))
    ...
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="ecru", laize=240, longueur=500, poses=[0]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="ecru", laize=240, longueur=500, poses=[1]))
    i += 1
    ...
    bobine_store.add_bobine(Bobine(code=i, color="ecru", laize=260, longueur=500, poses=[0]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="ecru", laize=300, longueur=500, poses=[0]))
    i += 1
    ...
    bobine_store.add_bobine(Bobine(code=i, color="ecru", laize=320, longueur=500, poses=[0]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="ecru", laize=320, longueur=500, poses=[1]))
    i += 1
    bobine_store.add_bobine(Bobine(code=i, color="ecru", laize=320, longueur=500, poses=[1]))